  ...
  if (!sentMessage) {
      ...
      return (
        <div className="forms__form">
          ...
          <input
            ...
            id="email"
            name="email"
            className="input-field forms__form__field"
          />
        </div>
      );
    }
    ...
    function MessageInput() {
      return (
        <div className="forms__form">
          ...
          <textarea
            placeholder="Example : Hey Desmond, I would like to book a tour for five persons. We will be arriving on June 13,2021 at 10:00 am"
            ref={messageElement}
            required
            id="message"
            name="message"
    ...
    return (
      <section className="section-form-tours">
        ...
        <Form />
        <p>Can't wait for an email ? Call us at +1 (876) 855-9645</p>
      </section>
    );
  } else {
    return (
      <p style={{ margin: "2rem", textAlign: "center" }}>
        Thank you! {sentMailResponse}{" "}
      </p>
    );
  }
}
